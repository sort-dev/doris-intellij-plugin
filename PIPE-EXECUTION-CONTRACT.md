...
`dev.brikk.house:brikk-sql-jvm:0.13.0` and `brikk-sql-metadata-jvm:0.13.0`, both
confirmed on Maven Central. See [the upgrade report](REVIEW-brikk-sql-0.13.0.md)
...
In 0.13.0, invalid pipe pagination uses these existing typed errors. Unexpanded
